...
node5 = node.Node(5,env,2,200,30)
node6 = node.Node(6,env,2,210,50)
node7 = node.Node(7,env,2,199,72)
node8 = node.Node(8,env,2,191,47)
node9 = node.Node(9,env,2,215,200)
node10 = node.Node(10,env,2,190,200)
node11 = node.Node(11,env,2 ,220,220 )
...
node20 = node.Node(20,env,2 ,120,20 )
node21 = node.Node(21,env,2,105,2 )
node22 = node.Node(22,env,2 ,135,5 )
