...
node16 = node.Node(16,env,1.8634754 ,29,189 ,node_type=None, power_type=1, mobile_type=0, ieee802154=ieee802154, sensor_type=1)
node17 = node.Node(17,env,1.87648 ,35,204)
node18 = node.Node(18,env,1.7645,31,172 ,node_type=None, power_type=1, mobile_type=0, ieee802154=ieee802154, sensor_type=1)
