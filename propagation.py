"""
https://github.com/farrukhshahzad/pymote2.0/blob/54a30bc2af4ed35b33e62b4eaea99af30fc0fdff/pymote/propagation.py
Propagation pymote 2.0
...
# shadowing uses free_space
    ...
    def shadowingshadowing_rssi(self, d=1.0, p_tx=None):
...
# get_power_ratio uses shadowing and two_ray_ground and freespace
